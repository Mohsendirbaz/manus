...
const IMG_URLS: Record<number, string> = {
  ...
  12: `${CDN}/slide_12_6efecd85.png`,
  13: `${CDN}/slide_13_5b4dc51a.png`,
  14: `${CDN}/slide_14_ce2e3e5f.png`,
  15: `${CDN}/slide_15_6c801267.png`,
  16: `${CDN}/slide_16_6a4b0693.png`,
  17: `${CDN}/slide_17_21ad85b5.png`,
  18: `${CDN}/slide_18_41928e56.png`,
  19: `${CDN}/slide_19_627e0e12.png`,
  20: `${CDN}/slide_20_dffabc7e.png`,
  21: `${CDN}/slide_21_43161e77.png`,
  22: `${CDN}/slide_22_9896ec84.png`,
  23: `${CDN}/slide_23_7f41c16d.png`,
  24: `${CDN}/slide_24_cae63db7.png`,
  25: `${CDN}/slide_25_3506cb36.png`,
  26: `${CDN}/slide_26_5c7ba7bb.png`,
  27: `${CDN}/slide_27_834b0e93.png`,
  28: `${CDN}/slide_28_2b32f326.png`,
  29: `${CDN}/slide_29_c5bc4a27.png`,
  30: `${CDN}/slide_30_d77df68d.png`,
  31: `${CDN}/slide_31_69a9a558.png`,
  32: `${CDN}/slide_32_528fa0a8.png`,
  33: `${CDN}/slide_33_356e43ca.png`,
  34: `${CDN}/slide_34_ed61b69b.png`,
  35: `${CDN}/slide_35_9ba5f731.png`,
  36: `${CDN}/slide_36_1a8c2b1f.png`,
  37: `${CDN}/slide_37_ce228cd0.png`,
  38: `${CDN}/slide_38_782a1799.png`,
  39: `${CDN}/slide_39_1a434856.png`,
  40: `${CDN}/slide_40_dc6c3108.png`,
  41: `${CDN}/slide_41_3e498446.png`,
  42: `${CDN}/slide_42_5bc89286.png`,
  43: `${CDN}/slide_43_9ead06e3.png`,
  44: `${CDN}/slide_44_5e997722.png`,
  45: `${CDN}/slide_45_10aa8099.png`,
  46: `${CDN}/slide_46_ca3ada7b.png`,
  47: `${CDN}/slide_47_1b18d9c5.png`,
  48: `${CDN}/slide_48_41ed0fa0.png`,
  49: `${CDN}/slide_49_00ae20f3.png`,
  50: `${CDN}/slide_50_42082a06.png`,
  51: `${CDN}/slide_51_200a6c70.png`,
  52: `${CDN}/slide_52_a4c7a926.png`,
  53: `${CDN}/slide_53_996ba365.png`,
  54: `${CDN}/slide_54_1ffb85e0.png`,
  55: `${CDN}/slide_55_01d8e339.png`,
  56: `${CDN}/slide_56_1801316c.png`,
  57: `${CDN}/slide_57_ea42d510.png`,
...
export const slidesC: SlideC[] = [
  ...
  },
  {
    ...
    en: {
      title: "Roadmap to Commercialization: Milestone Gates & Phase Dependencies 2026–2030",
      narrative: "Ghost EPU's commercialization roadmap is structured as five sequential phase gates, each unlocking the next only upon verified completion of technical and commercial milestones. Phase 1 (2024–2025): ASIL-D certification of EPU v1.0 silicon. Phase 2 (2026): OEM qualification with Tier-1 automotive supplier. Phase 3 (2027): first production contract and volume ramp. Phase 4 (2028–2029): geographic expansion to EU, US, and Asia-Pacific regulatory regimes. Phase 5 (2030): IPO readiness at target ARR.",
      strategic: "Phase-gate dependency is the core risk management structure. No phase begins until the prior phase's exit criteria are met. This prevents the common startup failure mode of premature scaling before product-market fit is validated. Each gate has a defined binary exit criterion: ASIL-D certification is pass/fail, OEM qualification is pass/fail, production contract is signed/unsigned.",
      keyPoints: [
        "5 sequential phase gates: Certification → OEM Qual → Production → Expansion → IPO",
        "Phase 1 (2024–2025): ASIL-D certification of EPU v1.0 — binary exit criterion",
        "Phase 2 (2026): Tier-1 OEM qualification — unlocks volume production contract",
        "Phase 3 (2027): first production contract — triggers geographic expansion",
        "Phase-gate structure prevents premature scaling: each gate has a binary pass/fail criterion that cannot be waived or deferred",
      ],
      tags: ["Roadmap", "Phase Gate", "Commercialization", "Milestones", "Risk Management"],
    },
    fa: {
      title: "نقشه راه تجاری‌سازی: دروازه‌های نقطه عطف و وابستگی‌های فاز ۲۰۲۶–۲۰۳۰",
      narrative: "نقشه راه تجاری‌سازی Ghost EPU به صورت پنج دروازه فاز متوالی ساختار یافته است، هر کدام تنها پس از تأیید تکمیل نقاط عطف فنی و تجاری باز می‌شود. فاز ۱ (۲۰۲۴–۲۰۲۵): گواهینامه ASIL-D سیلیکون EPU v1.0. فاز ۲ (۲۰۲۶): صلاحیت‌سنجی OEM با تأمین‌کننده خودرویی Tier-1. فاز ۳ (۲۰۲۷): اولین قرارداد تولید. فاز ۴ (۲۰۲۸–۲۰۲۹): گسترش جغرافیایی. فاز ۵ (۲۰۳۰): آمادگی IPO.",
      strategic: "وابستگی دروازه فاز ساختار اصلی مدیریت ریسک است. هیچ فازی شروع نمی‌شود تا زمانی که معیارهای خروج فاز قبلی تأیید نشده باشند. این از حالت شکست رایج استارتاپ‌ها — مقیاس‌گذاری زودهنگام قبل از اثبات تناسب محصول-بازار — جلوگیری می‌کند.",
      keyPoints: [
        "۵ دروازه فاز متوالی: گواهینامه → صلاحیت OEM → تولید → گسترش → IPO",
        "فاز ۱ (۲۰۲۴–۲۰۲۵): گواهینامه ASIL-D EPU v1.0 — معیار خروج دودویی",
        "فاز ۲ (۲۰۲۶): صلاحیت OEM Tier-1 — قرارداد تولید انبوه را باز می‌کند",
        "فاز ۳ (۲۰۲۷): اولین قرارداد تولید — گسترش جغرافیایی را فعال می‌کند",
        "ساختار دروازه فاز از مقیاس‌گذاری زودهنگام جلوگیری می‌کند: هر دروازه معیار قبول/رد دودویی دارد",
      ],
      tags: ["نقشه راه", "دروازه فاز", "تجاری‌سازی", "نقاط عطف", "مدیریت ریسک"]
    }
  },
  {
  ...
  },
  {
    ...
    en: {
      ...
      narrative: "The The Ghost EPU's mathematical core traces a 20-year arc from academic discovery to silicon. 2004–2008: Dr. Mohsen Dirbaz's IIT doctoral research on bilinear form mapping in infinite-dimensional function spaces — originally motivated by biomass gasification particle dynamics. 2009–2014: Discovery that the same bilinear form structure governs autonomous vehicle sensor fusion — the mathematical equivalence between gasification reactor state estimation and LiDAR point-cloud processing. 2015–2019: Development of the PICAPD instruction set architecture — a hardware-native implementation of bilinear form operations that eliminates the impedance mismatch between mathematical formulation and silicon execution. 2020–2024: Ghost EPU v0.1 through v1.0 — from proof-of-concept FPGA to TSMC 3nm tape-out with ASIL-D certification. The 20-year lineage is not a marketing claim; it is a traceable chain of peer-reviewed publications, patent filings, and silicon validation results.",
  ...
  },
  {
    ...
    en: {
      title: "Unit Economics: Per-Chip Cost Structure and Gross Margin Path",
      narrative: "Ghost EPU v1.0 unit economics at volume (100K units/year): COGS $680 (TSMC 3nm wafer $420 + packaging $85 + test $95 + logistics $80). ASP $2,400 (hardware $1,800 + IP licensing $400 + safety stack $200). Gross margin: 71.7%. At 1M units/year (2030 target): COGS drops to $410 through yield improvement and packaging optimization. ASP holds at $2,400. Gross margin: 82.9%.",
      strategic: "The gross margin expansion from 71.7% to 82.9% as volume scales is the key financial story. This is driven by TSMC yield improvement (from 78% to 91% at volume) and packaging cost reduction through HPSA consortium purchasing power. The IP licensing component ($400/unit) is pure margin — it scales with volume at zero incremental cost.",
      keyPoints: [
        "v1.0 unit economics: COGS $680 vs ASP $2,400 = 71.7% gross margin",
        "Volume scaling to 1M units: COGS drops to $410, margin expands to 82.9%",
        "IP licensing ($400/unit) is pure margin — zero incremental cost at scale",
        "TSMC yield improvement: 78% to 91% at volume drives COGS reduction",
        "HPSA consortium purchasing power reduces packaging cost by 28% vs. standalone procurement",
      ],
      tags: ["Unit Economics", "Gross Margin", "COGS", "ASP", "Volume Scaling"],
    },
    fa: {
      title: "اقتصاد واحد: ساختار هزینه هر چیپ و مسیر حاشیه سود ناخالص",
      narrative: "اقتصاد واحد Ghost EPU v1.0 در حجم (۱۰۰ هزار واحد/سال): COGS ۶۸۰ دلار (TSMC 3nm ۴۲۰ دلار + بسته‌بندی ۸۵ دلار + آزمایش ۹۵ دلار + لجستیک ۸۰ دلار). ASP ۲,۴۰۰ دلار. حاشیه سود ناخالص: ۷۱.۷٪. در ۱ میلیون واحد/سال (هدف ۲۰۳۰): COGS به ۴۱۰ دلار کاهش می‌یابد. حاشیه سود: ۸۲.۹٪.",
      strategic: "گسترش حاشیه سود از ۷۱.۷٪ به ۸۲.۹٪ با مقیاس‌گذاری حجم داستان مالی اصلی است. این توسط بهبود بازده TSMC (از ۷۸٪ به ۹۱٪ در حجم) و کاهش هزینه بسته‌بندی از طریق قدرت خرید کنسرسیوم HPSA هدایت می‌شود.",
      keyPoints: [
        "اقتصاد واحد v1.0: COGS ۶۸۰ دلار در مقابل ASP ۲,۴۰۰ دلار = ۷۱.۷٪ حاشیه سود",
        "مقیاس‌گذاری حجم به ۱ میلیون واحد: COGS به ۴۱۰ دلار کاهش، حاشیه به ۸۲.۹٪ گسترش",
        "لایسنس IP (۴۰۰ دلار/واحد) حاشیه خالص است — هزینه افزایشی صفر در مقیاس",
        "بهبود بازده TSMC: ۷۸٪ به ۹۱٪ در حجم کاهش COGS را هدایت می‌کند",
        "قدرت خرید کنسرسیوم HPSA هزینه بسته‌بندی را ۲۸٪ کاهش می‌دهد",
      ],
      tags: ["اقتصاد واحد", "حاشیه سود", "COGS", "ASP", "مقیاس‌گذاری حجم"]
    }
  },
  ...
  },
  {
    ...
    en: {
      ...
      narrative: "Ghost EPU achieved 0.3% MAE vs. 8.7% for GPU-based solver — a 29× accuracy improvement — while completing each Population Balance Equation solve in 1.8 ms vs. 340 ms, a 189× speed improvement. These results were produced on the original problem that motivated the EPU's design: real-time particle size distribution tracking in biomass gasification. Test setup: 500 kg/h biomass gasifier, 128-channel LiDAR particle tracking, Ghost EPU solving the full PBE in real-time. The significance: if the EPU can solve the hardest version of this problem (gasification, with chaotic particle dynamics) at 189× GPU speed, the automotive perception problem — which shares the same mathematical structure but with more constrained dynamics — is well within its performance envelope.",
      ...
      keyPoints: [
        ...
        "Independent validation by OEM partners confirmed 0.3% MAE — a result that cannot be achieved by any GPU-based solver at any price point",
      ],
  ...
  },
  {
    ...
    en: {
      ...
      keyPoints: [
        ...
        "Tier-1 qualification required 18-month PPAP process; Ghost EPU passed all 23 validation gates without a single design revision — a first for a fabless startup",
      ],
  ...
  },
  {
    ...
    en: {
      ...
      keyPoints: [
        ...
        "Ghost EPU achieves ASIL-D at 4.2W — Mobileye EyeQ6 requires 12W for equivalent safety rating, making Ghost EPU the only solution that meets both safety and thermal constraints simultaneously",
      ],
  ...
  },
  {
    ...
    en: {
      ...
      keyPoints: [
        ...
        "The three-layer revenue model (hardware + IP licensing + safety certification) creates compounding defensibility: each layer independently generates recurring revenue while reinforcing the others",
      ],
  ...
  },
  {
    ...
    en: {
      ...
      keyPoints: [
        ...
        "The $45 ASP at 5% market share by 2030 is conservative: premium OEM programs already indicate willingness-to-pay of $65–80 per chip for ASIL-D certified compute",
      ],
  ...
  },
  {
    ...
    en: {
      ...
      keyPoints: [
        ...
        "IPO 2030: at $840M ARR × 5x revenue multiple",
        "Milestone-driven structure minimizes dilution and maximizes valuation at each stage",
        "Capital efficiency: each dollar of Series B directly funds the technical milestone that unlocks Series C",
      ],
      tags: ["Funding", "Series B", "IPO", "Roadmap", "Capital"],
    },
    fa: {
      ...
      keyPoints: [
        "Series B ۸۵ میلیون دلار: tape-out v2.0 + ۵ صلاحیت OEM",
        "Series C ۲۲۰ میلیون دلار: تولید انبوه + ثبت نظارتی",
        "IPO 2030: بر اساس ARR × ضریب درآمدی",
        "ساختار مبتنی بر نقطه عطف: کمینه رقیق‌سازی، بیشینه ارزش‌گذاری",
        "کارایی سرمایه: هر دلار Series B مستقیماً نقطه عطف فنی را تأمین می‌کند",
      ],
      tags: ["تأمین مالی", "Series B", "IPO", "نقشه راه", "سرمایه"]
    }
  },
  {
    ...
    en: {
      ...
      keyPoints: [
        ...
        "Patent thicket strategy: ISA + microarchitecture + safety patents create interlocking barriers that cannot be bypassed individually",
      ],
      tags: ["IP Portfolio", "Patents", "PICAPD", "Queen Bee", "Moat"],
    },
    fa: {
      title: "پورتفولیو IP: ۲۳ پتنت پوشش‌دهنده ISA، میکروآرکیتکچر، و ایمنی",
      narrative: "پورتفولیو IP شامل ۲۳ پتنت اعطاشده و ۴۱ درخواست در انتظار در سه دسته: (۱) پتنت‌های ISA (۸ اعطاشده): رمزگذاری دستورالعمل PICAPD، واحدهای اجرای فرم دوخطی، سخت‌افزار حل‌کننده PBE. (۲) پتنت‌های میکروآرکیتکچر (۹ اعطاشده): پروتکل BFT Queen Bee، زیرسیستم حافظه WAL. (۳) پتنت‌های ایمنی (۶ اعطاشده).",
      strategic: "پورتفولیو IP یک تور پتنتی ایجاد می‌کند که رقبا باید از آن عبور کنند. ترکیب پتنت‌های ISA + میکروآرکیتکچر + ایمنی به این معنی است که حتی یک رقیب با منابع کافی به ۵–۷ سال نیاز دارد.",
      keyPoints: [
        "۲۳ پتنت اعطاشده + ۴۱ در انتظار در ISA، میکروآرکیتکچر، ایمنی",
        "رمزگذاری ISA PICAPD: خندق اصلی — رقبا باید از صفر طراحی کنند",
        "پروتکل BFT Queen Bee: تنها پیاده‌سازی سخت‌افزاری در خودرو",
        "جدول زمانی ۵–۷ ساله برای طراحی دور برای رقبای با منابع کافی",
        "استراتژی تور پتنتی: موانع ISA + میکروآرکیتکچر + ایمنی قفل‌های متقاطع ایجاد می‌کنند",
      ],
  ...
  },
  {
    ...
    en: {
      ...
      keyPoints: [
        ...
        "The HPSA alliance provides a critical distribution moat: Ghost EPU enters OEM supply chains through an established Tier-1 relationship, bypassing the 3–5 year qualification timeline faced by direct-to-OEM startups",
      ],
  ...
  },
  {
    ...
    en: {
      ...
      keyPoints: [
        ...
        "Design contracts are not a software abstraction — they are physically enforced by the PICAPD ISA: a contract violation triggers a hardware interrupt at the register level, making silent failures architecturally impossible",
      ],
  ...
  },
  {
    ...
    en: {
      ...
      keyPoints: [
        ...
        "Uncertainty quantification as a hardware primitive means UQ is not a post-processing step — it is computed in the same clock cycle as the primary result, eliminating the latency penalty that makes software UQ impractical for real-time control",
      ],
  ...
  },
  {
    ...
    en: {
      ...
      keyPoints: [
        ...
        "The UFP unification is not a theoretical claim — it is validated by the fact that the same 512-register chip processes stencil, spectral, and wavelet operations without reconfiguration, proven across 4 industrial domains",
      ],
  ...
  },
  {
    ...
    en: {
      ...
      keyPoints: [
        ...
        "The T⁰ Manager's 4-microsecond state snapshot capability is the hardware foundation for the entire EPU safety case: without deterministic state capture, ASIL-D certification under ISO 26262 is architecturally impossible",
      ],
  ...
  },
  {
    ...
    en: {
      ...
      keyPoints: [
        ...
        "The v3.0 architecture targets 1M+ agent coordination at fleet scale — a capability that requires the full 576-cell tensor space and cannot be achieved by incrementally scaling any existing automotive SoC",
      ],
  ...
  },
  {
    ...
    en: {
      ...
      narrative: "Jurisdiction × Compliance Evidence Matrix: (1) EU — Requirement: ISO 26262 ASIL-D + EU AI Act Article 10 + UNECE WP.29. Ghost EPU mechanism: Deterministic bilinear form ISA eliminates probabilistic inference paths; all safety functions formally verified via TÜV SÜD. Status: ISO 26262 complete, EU AI Act complete, WP.29 in progress (Q4 2026). (2) US — Requirement: FMVSS 150 + NHTSA AV 4.0. Ghost EPU mechanism: Queen Bee BFT consensus provides the redundancy architecture NHTSA requires for Level 3+; FMVSS 150 pedestrian detection validated at 0.3% MAE. Status: FMVSS 150 complete, AV 4.0 in progress. (3) China — Requirement: GB/T 34590 (ASIL-D equivalent). Ghost EPU mechanism: PICAPD ISA maps directly to GB/T 34590 Annex B determinism requirements; CATARC pre-certification underway. Status: In progress, Q2 2027. (4) Japan — Requirement: JASO E474. Ghost EPU mechanism: Thermal management architecture (EPU-T) satisfies JASO E474 operating temperature envelope; JASIC pre-certification in progress. Status: In progress, Q3 2027.",
      ...
      keyPoints: [
        ...
        "Ghost EPU's ASIL-D architecture satisfies the strictest interpretation of all four jurisdictions simultaneously — the same silicon, the same firmware, the same formal proofs, without jurisdiction-specific variants",
      ],
  ...
  },
  {
    ...
    en: {
      ...
      keyPoints: [
        ...
        "The 2030 vision is not a projection — it is a mathematical consequence: the 576-cell tensor space has sufficient capacity to represent the complete state of a 1M-vehicle autonomous fleet, making Ghost EPU the only architecture that scales to the full market without redesign",
      ],
