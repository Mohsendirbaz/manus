...
export const slidesC: SlideC[] = [
  ...
  },
  {
    ...
    fa: {
      ...
      keyPoints: ["دقت ردیابی ۹۸.۷٪ در برابر ۷۵.۳٪ GPU", "مصرف توان ۱۲۰ برابر کمتر از A100", "اعتبارسنجی کامل معادلات PBE", "پایه‌ای برای تمام کاربردهای صنعتی"],
  ...
  },
  {
    ...
    fa: {
      ...
      keyPoints: ["۰ خرابی در ۲.۳ میلیون ساعت شبیه‌سازی", "ASIL-D در ۱۴ ماه در برابر ۲۴ ماه میانگین", "محدوده حرارتی -۴۰°C تا +۱۲۵°C", "سه صلاحیت‌سنجی OEM همزمان"],
  ...
  },
  {
    ...
    fa: {
      ...
      keyPoints: ["تأخیر ۱۵ برابر بهتر از Orin", "کارایی توان ۱۱.۹ برابر بهتر (TOPS/W)", "تنها پردازنده با ASIL-D + BFT بومی", "برنده تمام ۵ بُعد بنچمارک"],
  ...
  },
  {
    ...
    fa: {
      ...
      keyPoints: ["سخت‌افزار: ۴.۸ میلیارد دلار تا ۲۰۳۰", "لایسنس IP: ۰.۱۵ دلار/TOPS-ساعت", "بسته ایمنی: ۱۸۰ هزار دلار/پلتفرم", "سه خندق مستقل: سخت‌افزار، IP، نظارتی"],
  ...
  },
  {
    ...
    fa: {
      ...
      keyPoints: ["TAM ۸۴۷ → SAM ۱۲۴ → SOM ۱۲.۴ میلیارد دلار تا ۲۰۳۰", "الزامات نظارتی: EU 2026، US 2027، چین 2028", "پنجره ۲۴ ماهه انحصار رقابتی", "۱۰٪ SAM = ۱۲.۴ میلیارد دلار"],
  ...
  },
  {
    ...
    fa: {
      ...
      keyPoints: ["Series B ۸۵ میلیون دلار: tape-out v2.0 + ۵ صلاحیت OEM", "Series C ۲۲۰ میلیون دلار: تولید انبوه + ثبت نظارتی", "IPO 2030: ۴.۲ میلیارد دلار ارزش‌گذاری", "ساختار مبتنی بر نقطه عطف"],
  ...
  },
  {
    ...
    fa: {
      ...
      keyPoints: ["۲۳ پتنت اعطاشده + ۴۱ در انتظار", "رمزگذاری ISA PICAPD: خندق اصلی", "پروتکل BFT Queen Bee: تنها پیاده‌سازی سخت‌افزاری در خودرو", "جدول زمانی ۵–۷ ساله برای طراحی دور"],
  ...
  },
  {
    ...
    fa: {
      ...
      keyPoints: ["HPSA: کنسرسیوم ۷ شرکتی پوشش کامل پشته", "۴۰٪ سریع‌تر به بازار، ۲۸٪ هزینه کمتر", "Quad-Plus: تولید در ۴ کشور", "ارزش‌گذاری پلتفرم: ۳–۵ برابر بالاتر"],
  ...
  },
  {
    ...
    fa: {
      ...
      keyPoints: ["CSS: قراردادهای رسمی صحت محاسباتی", "قراردادهای اطلاعاتی: اصل Landauer در طراحی سخت‌افزار", "قراردادهای زمانی: WCET، jitter، تأخیر", "PDC گواهینامه ASIL-D را از طریق تأیید رسمی عملی می‌کند"],
  ...
  },
  {
    ...
    fa: {
      ...
      keyPoints: ["UQ به عنوان primitive سخت‌افزاری", "قضیه Moment-Isomorphism: لحظات خروجی از لحظات ورودی", "قانون AI EU + ISO 21448 نیاز به خروجی UQ گواهی‌شده دارند", "Ghost EPU: تنها پردازنده با UQ سخت‌افزاری گواهی‌شده"],
  ...
  },
  {
    ...
    fa: {
      ...
      keyPoints: ["UFP: (K, D, M, B, C) — پنج مؤلفه همه پردازش سیگنال را یکپارچه می‌کنند", "Stencil، FFT، Kalman، بیزی — همه نمونه‌های UFP", "کاهش ۳۴٪ مساحت سیلیکون", "یک واحد سخت‌افزاری همه حالت‌های پردازش سیگنال را مدیریت می‌کند"],
  ...
  },
  {
    ...
    fa: {
      ...
      keyPoints: ["T⁰ Manager: واحد سخت‌افزاری اختصاصی برای سازگاری حالت زمانی", "سه ثابت: سازگاری علّی، یکنواختی زمانی، یکپارچگی حالت", "کران Landauer اجرا می‌شود", "کاهش تأیید رسمی از منطق زمانی به بررسی ثابت"],
  ...
  },
  {
    ...
    fa: {
      ...
      keyPoints: ["v1.0 (5nm): 47.6 TOPS/W، 4.2W، BFT n=7", "v2.0 (3nm، 2027): 94.2 TOPS/W (+98٪)، 3.1W", "v3.0 (2nm، 2030): 180+ TOPS/W، BFT کوانتوم-مقاوم", "هر نسل: TOPS/W دو برابر، توان کاهش"],
  ...
  },
  {
    ...
    fa: {
      ...
      keyPoints: ["EU: ASIL-D + قانون AI EU کامل", "US: FMVSS 150 کامل", "چین + ژاپن: Q2-Q3 2027", "همه ۴ بازار ASIL-D را برای L3+ تا 2027 الزامی می‌کنند"],
  ...
  },
  {
    ...
    fa: {
      ...
      keyPoints: ["۲۰۲۶: اولین خودروی تولیدی با Ghost EPU", "۲۰۲۸: انطباق نظارتی در EU، US، چین، ژاپن", "۲۰۲۹: ۱ میلیون واحد، ۸۴۰ میلیون دلار ARR", "۲۰۳۰: IPO با ارزش‌گذاری ۴.۲ میلیارد دلار"],
